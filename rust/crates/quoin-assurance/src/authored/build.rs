...
mod tests {
    ...
    /// Provenance: PLAT-966
    #[test]
    fn tc_1916_a_claim_backed_by_resolved_evidence_passes_clean() {
        let view = build(argument(), vec![decision()], AS_OF);
    ...
    /// Provenance: PLAT-966
    #[test]
    fn tc_1916_a_claim_with_no_evidence_references_is_unbacked() {
    ...
    /// Provenance: PLAT-966
    #[test]
    fn tc_1916_a_claim_citing_an_unresolved_reference_is_unbacked() {
    ...
    /// Provenance: PLAT-966
    #[test]
    fn tc_1916_a_claim_citing_stale_vacuous_or_suspect_evidence_is_unbacked() {
        let cases = [
    ...
    /// Provenance: PLAT-966
    #[test]
    fn tc_1916_reports_every_failing_reference_in_authored_order() {
        let claim = with(
            &argument()["top_claim"],
            "evidence_refs",
            serde_json::json!([
    ...
    /// Provenance: PLAT-966
    #[test]
    fn tc_1916_a_duplicate_evidence_index_entry_is_refused() {
