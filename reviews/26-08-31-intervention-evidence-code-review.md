...
`10cf60ac8b0ec5ca7a37831799d9ae77060f3870` (including the preceding assurance-gate repairs). The review covered the intervention
...
- Checked the agent-eval producer derives all decision-bearing values from two
  ...
  the observation clock. The governed definition also supplies immutable Quoin
  producer and cli-agent-evals subject revisions because the historical reports
  do not expose those source-control identities.
