...
describe("the merged catalog is read from module data", () => {
  // Trace: FR-031-AC-1
...
describe("an attack surface reaches DAST and SAST", () => {
  // Trace: FR-031-AC-2
...
describe("temporal phrasing reaches monitors and model checking", () => {
  // Trace: FR-031-AC-3
...
describe("a reliability NFR reaches fault injection", () => {
  // Trace: FR-031-AC-4
...
describe("a property shape reaches the property methods", () => {
  // Trace: FR-031-AC-5
...
describe("a mismatch with the authored cell is flagged, advisory only", () => {
  // Trace: FR-031-AC-6
...
describe("silence is reported as silence, not as a recommendation", () => {
  // Trace: FR-031-AC-7
...
describe("an unobservable axis is skipped, not failed", () => {
  // Trace: FR-031-AC-8
...
describe("an unreadable module manifest is reported, not thrown (FR-031-AC-9)", () => {
...
describe("characteristics are read from prose, not from link targets", () => {
  // Trace: FR-031-AC-14
...
describe("high-criticality is read from the obligation, not inferred", () => {
  // Trace: FR-031-AC-15
...
describe("the spec-side triggers for concolic execution", () => {
  // Trace: FR-031-AC-17
...
describe("the evidence-side facts", () => {
...
describe("structured parameters mint quantified-threshold (FR-031-AC-19)", () => {
...
describe("compound tokens do not leak fragment characteristics (FR-031-AC-20)", () => {
...
describe("architectural statements reach architecture-conformance (FR-031-AC-21)", () => {
...
describe("three states: mismatch, uncatalogued, inconclusive (FR-031-AC-22, AC-23)", () => {
