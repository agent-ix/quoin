  ...
  build: {
    lib: {
      entry: {
        ...
        "commands/change-assurance/index":
          "src/commands/change-assurance/index.ts",
        "commands/change-assurance/seal-record":
          "src/commands/change-assurance/seal-record.ts",
        "commands/change-assurance/seal-attestation":
          "src/commands/change-assurance/seal-attestation.ts",
        "commands/change-assurance/intake":
          "src/commands/change-assurance/intake.ts",
        "commands/change-assurance/receipt":
          "src/commands/change-assurance/receipt.ts",
        "commands/change-assurance/verify-receipt":
          "src/commands/change-assurance/verify-receipt.ts",
        "commands/change-assurance/schema":
          "src/commands/change-assurance/schema.ts",
        "commands/change-assurance/recover":
          "src/commands/change-assurance/recover.ts",
