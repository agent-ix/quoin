...
| FND-005 | high | Resolved: absent/unsupported input-schema declarations and malformed, empty, structurally incompatible, duplicate, or mismatched real-producer inputs fail without a record, and inadequate attribution cannot become a causal claim. | FR-058-AC-2; FR-058-AC-4; TC-1218; TC-1220 | missing-requirement |
| FND-006 | high | Resolved: record publication is an atomic no-replace operation, so a destination created after validation cannot be overwritten by the former check-then-rename race. | FR-057-AC-1; FR-057-AC-5; TC-1204; TC-1208 | missing-requirement |
