...
| FR-072 | ✅ Covered | `tests/semantic-mapping.test.ts` — TC-1353..TC-1359, TC-1715: `ClauseRef`/`OperationDecl` extraction, `quire` checked under semantic-core `0.2.0` and `ocl` carried under every version, language and duplicate rejection, dangling pre/post, inline-vs-external duplicate. |
...
| FR-072 | FR-072-AC-1, FR-072-AC-2, FR-072-AC-3, FR-072-AC-4, FR-072-AC-5, FR-072-AC-6, FR-072-AC-7, FR-072-CON-1 | TC-1353, TC-1354, TC-1355, TC-1356, TC-1357, TC-1358, TC-1359, TC-1715 | ✅ Complete |
...
| TC-1353 | Under semantic-core `0.2.0`, `quire` fences under `### notArchived` and `### archived` extract to the expected `ClauseRef`s and verbatim text with no diagnostic and a non-lossy clauses kind | Unit | P0 | FR-072-AC-1 | ✅ Complete |
...
| TC-1715 | The `fence-ocl-carried` case (semantic-core `0.2.0`) and the `config-version` golden (`0.1.0`) each carry the `ocl` body verbatim with one `semantic.clause-language-unchecked` advisory at the fence and a lossy clauses kind | Unit | P0 | FR-072-AC-7 | ✅ Complete |
