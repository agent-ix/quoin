...
| FR-063 | 🚧 Planned | TC-1261..TC-1271 specify the change-record schema, complete collections, proof premises, visible unknowns, RFC 8785/BLAKE3 sealing, mutation detection, malformed-input refusal, parent lineage and preservation, ix-flow decision binding, and non-identity boundary (`agent-ix/quoin#282`). |
| FR-064 | 🚧 Planned | TC-1272..TC-1280 specify proof-attestation bindings and states, retained-output integrity, canonical sealing, missing-field refusal, atomic/idempotent intake, unavailable evidence, store compatibility, and no-execution/non-verdict boundaries (`agent-ix/quoin#282`). |
| FR-065 | 🚧 Planned | TC-1281..TC-1292 specify reproducible receipt shape, outcome precedence, explicit attestation selection, exact binding, failed/stale/suspect/vacuous/missing evidence, ix-flow review decisions, incomplete impact/unknowns, unchanged FR-032 findings, determinism, compatibility, and non-identity terminology (`agent-ix/quoin#282`). |
...
| TC-1261 | Change-record schema v1 requires every identity, revision, parent, digest, subject, source, impact, definition, and review binding and refuses undeclared fields | Unit | P1 | FR-063-AC-1 | 🚧 planned for #282 |
| TC-1262 | Input permutations preserve required meaningful-empty collections, while duplicate source, requirement, constraint, proof, and unknown identities are refused | Property | P1 | FR-063-AC-2 | 🚧 planned for #282 |
| TC-1263 | Every requirement retains its reviewed statement, and every proof retains owning evidence obligations, literal argv, repository-relative cwd, evidence kind, tool identity, and configuration digest | Unit | P1 | FR-063-AC-3 | 🚧 planned for #282 |
| TC-1264 | Incomplete/truncated impact premises and every unknown disposition remain explicit and cannot become a completeness claim | Unit | P1 | FR-063-AC-4 | 🚧 planned for #282 |
| TC-1265 | Official RFC 8785 vectors produce pinned canonical UTF-8 bytes and pinned BLAKE3 lowercase-hex record digests across supported runtimes | Unit | P1 | FR-063-AC-5 | 🚧 planned for #282 |
| TC-1266 | Mutating each source, impact, definition, workflow, revision, and parent leaf independently invalidates the sealed record digest | Property | P1 | FR-063-AC-6 | 🚧 planned for #282 |
| TC-1267 | Duplicate names, lone surrogates, non-I-JSON numbers, locale ordering, uppercase/prefixed hex, and BOM bytes fail closed | Property | P1 | FR-063-AC-7 | 🚧 planned for #282 |
| TC-1268 | Genesis and successor lineage accepts only retained valid N-1 parents with the same record id and rejects missing, changed, skipped, and cross-record parents | Property | P1 | FR-063-AC-8 | 🚧 planned for #282 |
| TC-1269 | Sealing a successor leaves the parent path/bytes unchanged and preserves rejected and revise-requested revisions by digest | Integration | P1 | FR-063-AC-9, FR-063-CON-2 | 🚧 planned for #282 |
| TC-1270 | Only an intact matching ix-flow human review event for the exact run, kind, record, revision, and digest can approve a record | Integration | P1 | FR-063-AC-10 | 🚧 planned for #282 |
| TC-1271 | Static and golden-text checks prove sealing runs nothing and makes no identity, authority, signature, authenticity, or non-repudiation claim | Static | P1 | FR-063-AC-11, FR-063-CON-1, FR-063-CON-3 | 🚧 planned for #282 |
| TC-1272 | Proof-attestation schema v1 requires every record/candidate/proof/command/tool/config/environment/time/result/output binding and refuses undeclared fields | Unit | P1 | FR-064-AC-1 | 🚧 planned for #282 |
| TC-1273 | Passed, failed, unavailable, and not-computed producer results round-trip distinctly and intake assigns no verification verdict | Unit | P1 | FR-064-AC-2 | 🚧 planned for #282 |
| TC-1274 | Exact retained bytes reproduce BLAKE3 digest and size, while absent, changed, or extra bytes leave no newly stored artifact | Property | P1 | FR-064-AC-3 | 🚧 planned for #282 |
| TC-1275 | Attestation RFC 8785/BLAKE3 vectors are pinned and each semantic-field mutation invalidates the attestation digest | Property | P1 | FR-064-AC-4 | 🚧 planned for #282 |
| TC-1276 | Each absent record, candidate, proof, command, tool/configuration, environment, time, result, and output field is independently refused rather than inferred | Property | P1 | FR-064-AC-5, FR-064-CON-2 | 🚧 planned for #282 |
| TC-1277 | Identical intake is byte-idempotent, failures before atomic directory rename expose neither artifact and recover cleanly, and a same-digest changed-content collision preserves the first pair | Integration | P1 | FR-064-AC-6 | 🚧 planned for #282 |
| TC-1278 | Unavailable and not-computed attestations retain diagnostics, while wholly missing evidence creates no synthetic attestation | Unit | P1 | FR-064-AC-7 | 🚧 planned for #282 |
| TC-1279 | Existing FR-030 run records and readers remain byte-compatible beside the distinct proof-attestation store family | Integration | P1 | FR-064-AC-8 | 🚧 planned for #282 |
| TC-1280 | Static boundaries and golden terminology prove attestation intake runs nothing and assigns no audit, approval, identity, authorization, or non-repudiation conclusion | Static | P1 | FR-064-AC-9, FR-064-CON-1, FR-064-CON-3 | 🚧 planned for #282 |
| TC-1281 | Receipt schema v1 retains every record/candidate, workflow, parent, check, proof, auditor finding, unknown, outcome, reason, and digest field and refuses undeclared fields | Unit | P1 | FR-065-AC-1 | 🚧 planned for #282 |
| TC-1282 | Invalid dominates incomplete, incomplete dominates valid, and only a valid outcome permits an empty reason set under check permutations | Property | P1 | FR-065-AC-2 | 🚧 planned for #282 |
| TC-1283 | Every reviewed proof emits one ordered receipt; missing, duplicate, and unknown-proof selections fail distinctly, while unselected stored attestations have no effect | Property | P1 | FR-065-AC-3 | 🚧 planned for #282 |
| TC-1284 | Independent record, candidate, proof, argv/cwd, tool, and configuration mismatches invalidate the selected attestation and name the premise | Property | P1 | FR-065-AC-4 | 🚧 planned for #282 |
| TC-1285 | Only exact-output passed evidence with healthy owning obligations can discharge; failed, stale, suspect, vacuous, unrelated, mismatched, and other defect evidence is invalid | Property | P1 | FR-065-AC-5 | 🚧 planned for #282 |
| TC-1286 | Missing attestation/output, unavailable/not-computed result, and audit not-evaluated are incomplete and never passing or zero | Unit | P1 | FR-065-AC-6 | 🚧 planned for #282 |
| TC-1287 | Exactly one intact approval permits review validity; missing history/event is incomplete; duplicate decisions, broken chain, mismatch, rejection, and revise request are invalid | Integration | P1 | FR-065-AC-7 | 🚧 planned for #282 |
| TC-1288 | Incomplete/truncated impact and every non-resolved unknown stay named and force incomplete verification without blocking an advisory workflow | Unit | P1 | FR-065-AC-8 | 🚧 planned for #282 |
| TC-1289 | Every FR-032 finding kind and obligation id is retained byte-for-byte beside its mapped reason without changing the source auditor verdict | Integration | P1 | FR-065-AC-9, FR-065-CON-2 | 🚧 planned for #282 |
| TC-1290 | Input and selection permutations emit byte-identical canonical receipt JSON and the pinned RFC 8785/BLAKE3 digest | Property | P1 | FR-065-AC-10 | 🚧 planned for #282 |
| TC-1291 | Existing audit/assurance goldens remain byte-identical without selection and static boundaries prove receipt generation runs and writes nothing | Integration | P1 | FR-065-AC-11, FR-065-CON-1, FR-065-CON-4 | 🚧 planned for #282 |
| TC-1292 | Golden terminology describes actor labels and hashes only as recorded attribution and integrity, never identity, authority, authenticity, signature, or non-repudiation | Static | P1 | FR-065-AC-12, FR-065-CON-3 | 🚧 planned for #282 |
...
| US-017   | 🚧 Planned | TC-1261..TC-1292 cover revisioned definitions, exact integrity, workflow decisions, candidate-bound attestations, retained output, unchanged evidence-audit findings, valid/invalid/incomplete receipts, and non-identity boundaries; implementation is owned by `agent-ix/quoin#282`. |
