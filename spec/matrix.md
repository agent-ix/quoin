...
| TC-1249 | Fan-out emits one row per suite with the sorted distinct live obligations and owners; duplicate symbols and duplicate suite-obligation records do not inflate the count | Property | P0 | FR-062-AC-1 | 🚧 planned for #152 |
| TC-1250 | A binding whose obligation is absent from the accepted export remains named under its suite and in gaps while contributing nothing to the live-obligation count | Unit | P0 | FR-062-AC-2 | 🚧 planned for #152 |
| TC-1251 | The exact default and replacement relation sets are recorded; reverse dependency closure reaches transitive and shared dependents, terminates cycles, and selects the lexicographically first shortest path independent of input order | Property | P0 | FR-062-AC-3 | 🚧 planned for #152 |
| TC-1252 | Every reached requirement joins all live obligations and suites with depth and path; an unknown seed is a named gap with no partial closure for that seed | Unit | P0 | FR-062-AC-4 | 🚧 planned for #152 |
| TC-1253 | A reachable supported binding remains supported while change exposure is reported separately, and every other auditor verdict is copied byte-for-byte | Unit | P0 | FR-062-AC-5, FR-062-CON-3 | 🚧 planned for #152 |
| TC-1254 | One affirmation copied across several suite bindings deduplicates by obligation, actor, commit, and note while retaining every affected suite | Property | P0 | FR-062-AC-6 | 🚧 planned for #152 |
| TC-1255 | Churn retains zero-event live obligations, sorts count-descending then id, and reports affirmation history for an absent obligation only as a gap | Property | P0 | FR-062-AC-7 | 🚧 planned for #152 |
| TC-1256 | Every view carries the accepted full source revision and format/module premises byte-for-byte across repeated analysis of identical inputs | Property | P0 | FR-062-AC-8 | 🚧 planned for #152 |
| TC-1257 | Invalid, absent, unreadable, incomplete, and valid-empty fixtures produce their distinct refusal or report states and never collapse to a healthy zero | Unit | P0 | FR-062-AC-9 | 🚧 planned for #152 |
| TC-1258 | Reordered equivalent inputs emit byte-identical JSON, and human and JSON render from the same sorted report object | Property | P0 | FR-062-AC-10 | 🚧 planned for #152 |
| TC-1259 | Static boundaries reject producer, suite, Quire, Git, network, write, frontmatter-reader, and independently built graph dependencies from all three views | Static | P0 | FR-062-AC-11, FR-062-CON-1, FR-062-CON-4 | 🚧 planned for #152 |
| TC-1260 | Without graph invocation, evidence audit, assurance-case, and measurement goldens stay byte-identical; graph outputs contain no score or threshold classification | Integration | P0 | FR-062-AC-12, FR-062-CON-2 | 🚧 planned for #152 |
...
| US-018   | 🚧 Planned | TC-1249..TC-1260 cover exact fan-out, dependency closure, unchanged auditor verdicts, reaffirmation churn, unavailable inputs, deterministic rendering, and read-only/non-scoring boundaries; implementation is owned by `agent-ix/quoin#152`. |
