...
| FR-066 | 🚧 Planned | TC-1293..TC-1304 specify the versioned adapter registry, fail-closed Quire import, lossless graph handoff, graph-quality schema/id validation, exact raw attachment, explicit invocation attestation, plan gating, bijective normalization, non-measured states, atomic intake, and no-execution boundaries (`agent-ix/quoin#281`). |
| FR-067 | 🚧 Planned | TC-1305..TC-1315 specify current and historical graph evidence, complete partitions and provenance, availability states, compatibility-gated comparison, raw-evidence resolution, FR-062 embedding, repository-local failures, determinism, backward compatibility, and read-only/non-scoring boundaries (`agent-ix/quoin#281`). |
| StR-007 | 🚧 Planned | TC-1316 verifies the retained producer-to-portfolio flow preserves identity, partitions, availability, and compatibility without execution or an aggregate verdict. |
...
| FR-066 | FR-066-AC-1, FR-066-AC-2, FR-066-AC-3, FR-066-AC-4, FR-066-AC-5, FR-066-AC-6, FR-066-AC-7, FR-066-AC-8, FR-066-AC-9, FR-066-AC-10, FR-066-AC-11, FR-066-AC-12 | TC-1293, TC-1294, TC-1295, TC-1296, TC-1297, TC-1298, TC-1299, TC-1300, TC-1301, TC-1302, TC-1303, TC-1304 | 🚧 Planned |
| FR-067 | FR-067-AC-1, FR-067-AC-2, FR-067-AC-3, FR-067-AC-4, FR-067-AC-5, FR-067-AC-6, FR-067-AC-7, FR-067-AC-8, FR-067-AC-9, FR-067-AC-10, FR-067-AC-11 | TC-1305, TC-1306, TC-1307, TC-1308, TC-1309, TC-1310, TC-1311, TC-1312, TC-1313, TC-1314, TC-1315 | 🚧 Planned |
| StR-007 | StR-007-VC-1 | TC-1316 | 🚧 Planned |
...
| TC-1293 | The adapter registry exposes the two exact versioned graph adapters, and an unknown name fails with the available names before record parsing | Unit | P0 | FR-066-AC-1 | 🚧 planned for #281 |
| TC-1294 | A valid Quire export is preserved field-for-field, while unknown format, module-version, and schema-digest premises each fail before any graph record is returned | Unit | P0 | FR-066-AC-2 | 🚧 planned for #281 |
| TC-1295 | Standalone and portfolio graph views receive the same authoritative artifact, obligation, symbol, relation, observation, and availability records with no frontmatter read or relation translation | Integration | P0 | FR-066-AC-3, FR-066-CON-3 | 🚧 planned for #281 |
| TC-1296 | Graph-quality v1 validation recomputes the canonical observation id and refuses changed, missing, or unknown fields before constructing a collection | Property | P0 | FR-066-AC-4 | 🚧 planned for #281 |
| TC-1297 | The named scorer attachment is retained byte-for-byte with media type and digest; missing or changed bytes leave no collection | Property | P0 | FR-066-AC-5 | 🚧 planned for #281 |
| TC-1298 | Subject, scope, timestamp, environment, every verification-stack field, and immutable producer identity are independently required and never synthesized | Unit | P0 | FR-066-AC-6, FR-066-CON-2 | 🚧 planned for #281 |
| TC-1299 | An absent, inactive, wrong-id, or wrong-definition graph-quality plan is refused with expected and observed premises | Unit | P0 | FR-066-AC-7 | 🚧 planned for #281 |
| TC-1300 | Population totals and every language, node-kind, relation-kind, and resolver-tier census cell map bijectively to sorted count observations | Property | P0 | FR-066-AC-8 | 🚧 planned for #281 |
| TC-1301 | Every confusion component, unresolved count, ambiguous count, and recall ratio maps bijectively, while two facts mapping to one normalized key are refused | Property | P0 | FR-066-AC-9 | 🚧 planned for #281 |
| TC-1302 | Empty, unreadable, and unsupported inputs retain valid census rows, emit one distinct not-computed state, and emit no result row | Unit | P0 | FR-066-AC-10 | 🚧 planned for #281 |
| TC-1303 | Identical adapter intake is byte-idempotent, same-id changed content cannot replace a collection, and direct collection intake is unchanged | Integration | P0 | FR-066-AC-11, FR-066-CON-4 | 🚧 planned for #281 |
| TC-1304 | Static boundaries reject Quire, extractor, scorer, suite, Git, network, and frontmatter-reader dependencies from the adapters | Static | P0 | FR-066-AC-12, FR-066-CON-1, FR-066-CON-3 | 🚧 planned for #281 |
| TC-1305 | Each repository's current graph-quality row carries its active plan, definition, full producer tuple, source/corpus revisions, population identity, and raw record/scorer digests | Unit | P0 | FR-067-AC-1 | 🚧 planned for #281 |
| TC-1306 | History retains every structurally readable graph collection in timestamp/id order, including an explicitly incompatible record no longer governed by the active plan | Unit | P0 | FR-067-AC-2 | 🚧 planned for #281 |
| TC-1307 | Every measure/dimension/key partition remains separate under input and repository permutations; no partition or repository is summed or averaged | Property | P0 | FR-067-AC-3 | 🚧 planned for #281 |
| TC-1308 | Missing, unreadable, incompatible, unknown, and not-applicable availability remain distinct from measured/not-computed and from numeric zero | Property | P0 | FR-067-AC-4 | 🚧 planned for #281 |
| TC-1309 | Matching plans, definitions, configurations, tools, corpus revisions, and population identities permit a delta; changing each one independently blocks it and names the mismatch | Property | P0 | FR-067-AC-5 | 🚧 planned for #281 |
| TC-1310 | Current, history, and comparison rows resolve to the exact retained producer-record and scorer digests rather than copied summary fields | Integration | P0 | FR-067-AC-6 | 🚧 planned for #281 |
| TC-1311 | An accepted export/premises/audit triple embeds standalone FR-062 fan-out/churn and requested impact objects byte-for-byte; a partial triple is incompatible without reads, absent inputs are missing, and absent seeds are not-applicable | Integration | P0 | FR-067-AC-7, FR-067-CON-3 | 🚧 planned for #281 |
| TC-1312 | An unreadable repository, collection, attachment, or export is named locally without hiding readable repositories or structurally readable sibling collections in the same store | Unit | P0 | FR-067-AC-8 | 🚧 planned for #281 |
| TC-1313 | Equivalent repository arguments, changed-seed permutations, and store enumeration permutations emit byte-identical canonical JSON; conflicting export, premises, or audit mappings fail before reads; human output renders the same report object | Property | P0 | FR-067-AC-9 | 🚧 planned for #281 |
| TC-1314 | Historical measurement schemas and non-graph portfolio goldens remain readable without migration, and graph output contains no aggregate score or verdict | Integration | P0 | FR-067-AC-10, FR-067-CON-2, FR-067-CON-4 | 🚧 planned for #281 |
| TC-1315 | Static boundaries prove portfolio reporting executes and writes nothing and consumes FR-062 reports without recomputing graph semantics | Static | P0 | FR-067-AC-11, FR-067-CON-1, FR-067-CON-3 | 🚧 planned for #281 |
| TC-1316 | One retained producer fixture passes through the versioned adapter into a portfolio that preserves raw identity, partitions, availability, and compatibility premises while boundary sentinels observe no producer execution and no aggregate verdict | Integration | P0 | StR-007-VC-1 | 🚧 planned for #281 |
...
| US-019   | 🚧 Planned | TC-1293..TC-1315 cover lossless producer intake, plan/definition/population governance, raw evidence, graph history and partitions, availability, compatible comparisons, FR-062 portfolio views, and non-scoring; implementation is owned by `agent-ix/quoin#281`. |
