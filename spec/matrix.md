...
| FR-056 | 🚧 Planned | TC-1195..TC-1203 specify JSON-Schema validation for the record identity, producer tuple, designs, arms, variables, effects, uncertainty, conclusions, governance, and raw evidence (`agent-ix/quoin#268`; implementation `#270`). |
| FR-057 | 🚧 Planned | TC-1204..TC-1215 specify atomic intake, definition gating, idempotence/collision handling, negative outcomes, claim-centered rendering, determinism, non-execution, and backward compatibility (`agent-ix/quoin#268`; implementation `#270`). |
...
| TC-1197 | Repeated, randomized, and factorial designs accept their valid assignment combinations; zero repetitions and empty sampling conditions fail at their boundaries | Unit | P0 | FR-056-AC-3 | 🚧 planned for #270 |
| TC-1198 | A baseline plus one or many treatments, changed variables, and an explicit empty or populated held-constant list validate without collapsing their roles | Property | P0 | FR-056-AC-4 | 🚧 planned for #270 |
| TC-1199 | Numeric, textual, boolean, and unavailable effect values round-trip without coercing unavailable to zero | Property | P0 | FR-056-AC-5 | 🚧 planned for #270 |
| TC-1200 | Interaction and confounder entries preserve all four dispositions and never move between the two collections | Property | P0 | FR-056-AC-6 | 🚧 planned for #270 |
...
| TC-1202 | `causal_effect_established` requires a measured effect and non-none confidence; `cause_not_established` permits no effect and none confidence | Unit | P0 | FR-056-AC-8 | 🚧 planned for #270 |
| TC-1203 | Gaps, owner, actions, and content-digested raw evidence are required, and every undeclared field is refused recursively | Property | P0 | FR-056-AC-9 | 🚧 planned for #270 |
...
| TC-1205 | Every invalid schema path is reported and no store entry is written | Unit | P0 | FR-057-AC-2 | 🚧 planned for #270 |
| TC-1206 | An absent or mismatched governing definition names requested, expected, and observed versions and leaves the store unchanged | Unit | P0 | FR-057-AC-3 | 🚧 planned for #270 |
| TC-1207 | Repeating identical canonical bytes for one id is byte-idempotent | Property | P0 | FR-057-AC-4 | 🚧 planned for #270 |
| TC-1208 | A same-id/different-bytes collision cannot replace the retained entry | Property | P0 | FR-057-AC-5 | 🚧 planned for #270 |
| TC-1209 | Completed, failed, inconclusive, and cause-not-established records remain queryable with byte-identical raw-evidence digests | Unit | P0 | FR-057-AC-6 | 🚧 planned for #270 |
| TC-1210 | Experiment conclusions render as claims while measured effects and raw references render only as evidence | Unit | P0 | FR-057-AC-7 | 🚧 planned for #270 |
| TC-1211 | Unknown/uncontrolled interactions and confounders render as counterevidence, and gaps remain separate beside owner and actions | Unit | P0 | FR-057-AC-8 | 🚧 planned for #270 |
| TC-1212 | Human and JSON output contain no derived overall trust, confidence, or quality score and never infer causality from absent qualifiers | Static | P0 | FR-057-AC-9, FR-057-CON-2 | 🚧 planned for #270 |
| TC-1213 | Reordered store input renders byte-identically and human/JSON views expose the same claim-centered sections | Property | P0 | FR-057-AC-10 | 🚧 planned for #270 |
...
| US-015   | 🚧 Planned | TC-1195..TC-1215 cover record fidelity, negative outcomes, uncertainty, claim-centered rendering, governance, and non-scoring; implementation is owned by `agent-ix/quoin#270`. |
