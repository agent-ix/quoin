...
| US-015   | 🚧 Planned | TC-1195..TC-1216 cover record fidelity, negative outcomes, uncertainty, raw-evidence integrity, claim-centered rendering, governance, and non-scoring; implementation is owned by `agent-ix/quoin#270`. |
