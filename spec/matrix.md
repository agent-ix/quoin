...
| FR-059 | 🚧 Planned | TC-1222..TC-1230 specify the operational envelope, full control vocabulary, standing/exercise distinction, clock states, pinning, negative outcomes, governance, and raw evidence (`agent-ix/quoin#269`; implementation `#271`). |
| FR-060 | 🚧 Planned | TC-1231..TC-1242 specify atomic intake, definition gating, shape preservation, clocked discharge, claim-centered rendering, determinism, non-execution, and backward compatibility (`agent-ix/quoin#269`; implementation `#271`). |
...
| TC-1222 | The v1 envelope requires identities, deployed scope, record shape, control kind, governance, raw evidence, and every unchanged producer-tuple field | Unit | P0 | FR-059-AC-1 | 🚧 planned for #271 |
| TC-1223 | Every declared release, deployment, control, fallback, reporting, and version-pinning kind validates while an unknown kind is refused | Unit | P0 | FR-059-AC-2 | 🚧 planned for #271 |
| TC-1224 | A standing capability requires surface, availability, roles, coverage, limitations, transitions, and clock support at their minimum boundaries | Unit | P0 | FR-059-AC-3 | 🚧 planned for #271 |
| TC-1225 | An actual or drill exercise requires timing, actor, trigger, outcome, before/after state, observations, and clock applicability | Unit | P0 | FR-059-AC-4 | 🚧 planned for #271 |
| TC-1226 | Exactly one of capability and exercise is present for every generated valid record, and adding or removing the discriminator-matched payload fails | Property | P0 | FR-059-AC-5 | 🚧 planned for #271 |
| TC-1227 | Clocked exercises require start/deadline plus open, met, missed, or unknown status; not-applicable clocks accept only not-applicable status | Unit | P0 | FR-059-AC-6 | 🚧 planned for #271 |
| TC-1228 | Every pin control requires a typed identity, revision, and digest; an empty pin list fails | Unit | P0 | FR-059-AC-7 | 🚧 planned for #271 |
| TC-1229 | Succeeded, failed, partial, and aborted exercises all round-trip without collapsing their outcome | Property | P0 | FR-059-AC-8 | 🚧 planned for #271 |
| TC-1230 | Gaps, owner, actions, and content-digested raw evidence are required, and every undeclared field is refused recursively | Property | P0 | FR-059-AC-9 | 🚧 planned for #271 |
| TC-1231 | Valid intake writes exactly one complete canonical operational record by one atomic same-directory rename | Integration | P0 | FR-060-AC-1 | 🚧 planned for #271 |
| TC-1232 | Every invalid schema path is reported and no store entry is written | Unit | P0 | FR-060-AC-2 | 🚧 planned for #271 |
| TC-1233 | An absent or mismatched governing definition names requested, expected, and observed versions and leaves the store unchanged | Unit | P0 | FR-060-AC-3 | 🚧 planned for #271 |
| TC-1234 | Repeating identical canonical bytes for one id is byte-idempotent | Property | P0 | FR-060-AC-4 | 🚧 planned for #271 |
| TC-1235 | A same-id/different-bytes collision cannot replace the retained entry | Property | P0 | FR-060-AC-5 | 🚧 planned for #271 |
| TC-1236 | Both standing capabilities and every exercise outcome remain queryable with byte-identical raw-evidence digests | Unit | P0 | FR-060-AC-6 | 🚧 planned for #271 |
| TC-1237 | Only a matching exercise with `met` clock status discharges a clocked obligation; every other shape, scope, kind, subject, or clock state names non-discharge | Property | P0 | FR-060-AC-7 | 🚧 planned for #271 |
| TC-1238 | Capabilities and successful exercises render distinctly as claims/evidence while adverse or incomplete outcomes render as counterevidence/gaps beside owner/actions | Unit | P0 | FR-060-AC-8 | 🚧 planned for #271 |
| TC-1239 | Human and JSON output contain no derived overall trust, confidence, or quality score | Static | P0 | FR-060-AC-9 | 🚧 planned for #271 |
| TC-1240 | Reordered store input renders byte-identically and human/JSON views expose the same claim-centered sections | Property | P0 | FR-060-AC-10 | 🚧 planned for #271 |
| TC-1241 | Intake and reporting invoke, drill, or alter no operational control | Static | P0 | FR-060-CON-1 | 🚧 planned for #271 |
| TC-1242 | Existing measurement collections and pre-operational evidence remain readable without migration | Integration | P0 | FR-060-CON-2 | 🚧 planned for #271 |
...
| US-016   | 🚧 Planned | TC-1222..TC-1242 cover both operational shapes, the full control vocabulary, clocked discharge, adverse outcomes, claim-centered rendering, and non-scoring; implementation is owned by `agent-ix/quoin#271`. |
