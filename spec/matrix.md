...
| TC-1312 | An unreadable repository, collection, attachment, or export is named locally without hiding readable repositories or structurally readable sibling collections in the same store | Unit | P0 | FR-067-AC-8 | ✅ `quoin-measurement-graph` `tc_480_fr067_criteria.rs` :: `tc_480_044`, `tests/measurement-store-results.test.ts` |
