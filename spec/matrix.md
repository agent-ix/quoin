...
| TC-292 | Duplicate ids, unreadable documents, unresolved and unsupported relationships, orphan obligations, orphan implementations, and orphan bindings are each named and make the graph incomplete | Unit | P0 | FR-045-AC-2, FR-045-CON-3 | ✅ |
...
| TC-300 | A changed production path walks through Quire's existing implementation-scope records to requirements, obligations, suites, and upstream claims without counting scope as evidence | Unit | P0 | FR-045-AC-10 | ✅ |
