...
| TC-1277 | Identical intake is byte-idempotent and a same-digest changed-content collision preserves the first attestation and output | Integration | P1 | FR-064-AC-6 | 🚧 planned for #282 |
...
| TC-1283 | Every reviewed proof emits one ordered receipt; missing and duplicate selections fail distinctly, while unselected attestations have no effect | Property | P1 | FR-065-AC-3 | 🚧 planned for #282 |
...
| TC-1287 | Intact exact approval permits review validity; missing history/event is incomplete; broken chain, mismatch, rejection, and revise request are invalid | Integration | P1 | FR-065-AC-7 | 🚧 planned for #282 |
