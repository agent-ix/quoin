...
| FR-057 | 🚧 Planned | TC-1204..TC-1216 specify atomic intake, definition and raw-evidence gating, idempotence/collision handling, negative outcomes, claim-centered rendering, determinism, non-execution, and backward compatibility (`agent-ix/quoin#268`; implementation `#270`). |
| FR-058 | 🚧 Planned | TC-1217..TC-1221 specify the first real agent-eval comparison producer, exact raw-byte provenance, honest non-causal conclusions, and its no-subprocess boundary (`agent-ix/quoin#270`). |
...
| TC-1199 | Treatment-linked numeric, textual, boolean, and unavailable effect values round-trip without coercing unavailable to zero; duplicate treatment/metric keys fail | Property | P0 | FR-056-AC-5 | 🚧 planned for #270 |
...
| TC-1208 | A same-id/different-bytes collision returns `record_id_collision` and cannot replace the retained entry | Property | P0 | FR-057-AC-5 | 🚧 planned for #270 |
...
| TC-1212 | Human and JSON output contain no derived overall trust, confidence, or quality score and never infer causality from absent qualifiers | Unit | P0 | FR-057-AC-9, FR-057-CON-2 | 🚧 planned for #270 |
...
| US-015   | 🚧 Planned | TC-1195..TC-1216 and TC-1217..TC-1221 cover record fidelity, negative outcomes, uncertainty, raw-evidence integrity, claim-centered rendering, real producer behavior, governance, and non-scoring; implementation is owned by `agent-ix/quoin#270`. |
