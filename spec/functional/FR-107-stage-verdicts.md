...
- **FR-107-CON-3**: Under a plan that protects apparatus, FR-110-AC-6 adds
  ...
  `apparatus_unrecorded`; plans that protect nothing are unaffected. A gate's
  baseline is not apparatus-aware: that check is FR-108's, over the plan's
  full, order-attested history, not this requirement's single-row view.
