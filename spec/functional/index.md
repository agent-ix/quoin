...
- [FR-084: Pin and enumerate the governed corpus](./FR-084-pin-and-enumerate-the-governed-corpus.md)
- [FR-085: Resolve the completed module set and its contract surfaces](./FR-085-resolve-the-completed-module-set.md)
- [FR-086: Assign exactly one measurement state to every corpus document](./FR-086-assign-one-measurement-state-per-document.md)
- [FR-087: Evaluate declared Markdown mappings and validate the extracted record](./FR-087-evaluate-declared-markdown-mappings.md)
- [FR-088: Measure the L3 Properties representation of every measured document](./FR-088-measure-the-l3-properties-representation.md)
- [FR-089: Partition every failure with an owner and a disposition](./FR-089-partition-every-failure.md)
