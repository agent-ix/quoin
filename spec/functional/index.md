...
- [FR-084: Pin and enumerate the governed corpus](./FR-084-pin-and-enumerate-the-governed-corpus.md) — ⛔ **Withdrawn** (#388)
- [FR-085: Resolve the completed module set and its contract surfaces](./FR-085-resolve-the-completed-module-set.md) — ⛔ **Withdrawn** (#388)
- [FR-086: Assign exactly one measurement state to every corpus document](./FR-086-assign-one-measurement-state-per-document.md) — ⛔ **Withdrawn** (#388)
- [FR-087: Evaluate declared Markdown mappings and validate the extracted record](./FR-087-evaluate-declared-markdown-mappings.md) — ⛔ **Withdrawn** (#388)
- [FR-088: Measure the L3 Properties representation of every measured document](./FR-088-measure-the-l3-properties-representation.md) — ⛔ **Withdrawn** (#388)
- [FR-089: Partition every failure with an owner and a disposition](./FR-089-partition-every-failure.md) — ⛔ **Withdrawn** (#388)
- [FR-090: Publish every rate with its unit, population and method](./FR-090-publish-rates-with-unit-population-and-method.md) — ⛔ **Withdrawn** (#388)
- [FR-091: Account for known tool defects as cited, distinct states](./FR-091-account-for-known-tool-defects.md) — ⛔ **Withdrawn** (#388)
- [FR-092: Stay advisory and read-only over the corpus](./FR-092-stay-advisory-and-read-only.md) — ⛔ **Withdrawn** (#388)
...
- [FR-096: Expose a versioned Rust engine boundary](./FR-096-versioned-rust-engine-boundary.md)
- [FR-097: Source every boundary type from one schema and refuse hand-written duplicates](./FR-097-schema-sourced-type-surface.md)
- [FR-098: Preserve semantic and identity parity across every port](./FR-098-semantic-and-identity-parity.md)
- [FR-099: Provide catalog, module and validation capability in Rust](./FR-099-rust-catalog-and-validation-capability.md)
- [FR-100: Provide evidence, measurement and change-assurance capability in Rust](./FR-100-rust-evidence-measurement-change-assurance.md)
