...
- **Upstream**: accepted [ADR-0003](../../docs/semantic-module-architecture/adr/0003-rust-native-quoin-engine-boundary.md); completed [FR-096](./FR-096-versioned-rust-engine-boundary.md) through [FR-100](./FR-100-rust-evidence-measurement-change-assurance.md), whose capabilities this retires; the dependency-cycle break is [FR-100](./FR-100-rust-evidence-measurement-change-assurance.md)'s alone and is stated there, not spread across the five; [NFR-024](../non-functional/NFR-024-bounded-staged-coexistence.md), which defines the allowance manifest and the successor reference this requirement records against; quire-research LR03, which owns the shared capability-gap matrix.
