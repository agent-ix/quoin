...
| FR-048-AC-3 | The completed feasibility evidence is recorded as a modular JSON Schema 2020-12 recommendation for the next design stage, while TypeSpec remains unpromoted until ADR-0004 receives a separate human resolution. | Test (TC-1136) |
...
- This requirement does not promote TypeSpec, retire Avro, select one universal wire format, or
  authorize a schema or data migration.
