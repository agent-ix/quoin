...
description: "Index of stakeholder requirements (StR) for quoin."
---
...
- [StR-001: Authors run spec work from a standalone CLI](./StR-001-standalone-cli.md)
- [StR-002: Authors extend the spec vocabulary with community modules](./StR-002-extensible-vocabulary.md)
- [StR-003: Authoring and validation share one consistent catalog](./StR-003-shared-catalog.md)
